    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <nav className="bg-white border-b border-gray-100 px-12 py-5 flex items-center justify-between">
        ...
        <div className="flex gap-4">
          ...
          <Link href="/cadastro" className="text-sm font-bold text-white bg-accent px-6 py-3 rounded-lg shadow-lg shadow-accent/20 hover:bg-blue-700 transition-all">Participar do Programa</Link>
        </div>
      </nav>
            ...
            <>
              ...
              >
                {campaigns.map((campaign) => (
                  <div key={campaign.id} className="w-full h-full flex-shrink-0 relative">
                    <img

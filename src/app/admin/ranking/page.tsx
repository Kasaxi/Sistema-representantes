            ...
            <div className="max-w-6xl mx-auto space-y-8">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                        ...
                        <p className="text-gray-500 mt-1">Classificação oficial dos representantes por volume de vendas aprovadas.</p>
                    </div>
                </div>
                    ...
                    {loading ? (
                        ...
                        <div className="divide-y divide-gray-50">
                            {ranking.map((item, index) => (
                                <div key={item.id} className="p-6 flex items-center gap-6 hover:bg-gray-50 transition-colors group relative">
                                    {/* Position Badge */}
                                    <div className={`
